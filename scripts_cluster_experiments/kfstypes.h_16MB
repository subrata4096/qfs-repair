...
const size_t CHUNKSIZE = 16u << 20; //!< (64MB)
//extern size_t CHUNK_READ_SIZE = CHUNKSIZE; //!< (64MB), making it equal to CHUNKSIZE //subrata : previously it was 1MB
const size_t CHUNK_READ_SIZE = 16u << 20; //!< (64MB), making it equal to CHUNKSIZE //subrata : previously it was 1MB
    ...
    int inStripeSize)
{
    ...
    bool ret = (inStipedFileType == KFS_STRIPED_FILE_TYPE_NONE || (
    ...
    printf("inStripeSize = %d, KFS_MAX_STRIPE_SIZE = %d, ret = %d \n",inStripeSize, KFS_MAX_STRIPE_SIZE, ret);
    return ret;
}
