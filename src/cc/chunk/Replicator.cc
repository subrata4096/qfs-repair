...
private:
	...
	KFS_LOG_STREAM_DEBUG << "subrata: HandleRead : the mOwner = " << mOwner << KFS_LOG_EOM;
...
Replicator::Run(ReplicateChunkOp* op)
{
    ...
    if (op->location.IsValid()) {
        ...
        if (op->chunkOffset < 0 ||
            ...
            KFS_LOG_STREAM_DEBUG << "subrata: we have come to line 1884 of Replicator.cc and about to call RSReplicatorImpl::Create" << KFS_LOG_EOM; 
